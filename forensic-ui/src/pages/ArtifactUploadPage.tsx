            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm
                           ...
                           focus:border-indigo-400 disabled:opacity-50 transition-all"
              >
                <option value="">
                  {casesLoading ? 'Loading cases…' : cases.length === 0 ? 'No open cases — ask admin to create one' : 'Select a case…'}
                </option>
                {cases.map((c) => (
